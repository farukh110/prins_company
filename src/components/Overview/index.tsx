    ...
    <div className="mb-12 mt-18">
      ...
      <div className={activeTab === 'Reviews' ? 'block' : 'hidden'}>
        <div className="container mx-auto px-4">
          {reviews.map((review) => (
            <div key={review.id} className="p-3 mb-6 border border-gray-300 relative">
              <div className="flex gap-6">
                <div className="min-w-[136px] min-h-[136px] md:min-w-[150px] md:min-h-[150px]">
                  <Image
                    src={review.image}
                    alt={review.alt}
                    width={150}
              ...
              <div className="mt-8 md:mt-4 md:absolute md:bottom-3 md:right-3 w-full md:w-[calc(100%-198px)] flex justify-between flex-wrap">
          ...
          <div className="md:flex gap-14 justify-center">
            <div className="text-gray-800 w-full md:w-1/2">
              <div className="space-y-4">
                <h2 className="text-2xl font-bold">Discover Gorgeous Rings for Every Occasion</h2>
                <p>
                ...
                <h3 className="text-xl font-semibold">Rings for Her in a Variety of Styles</h3>
                <p>
                ...
                <h3 className="text-xl font-semibold">Customize the Perfect Ring for You</h3>
                <p>
              ...
              <div>
                <h2 className="text-lg md:text-xl font-normal leading-6 mb-5 text-gray-800 tracking-wide mt-4">
                  FAQs
                </h2>
                <div>
            ...
            <div className="w-full md:w-1/2 text-gray-800 text-center">
              <div className="sticky top-0">
                ...
                <table className="w-full">
                  ...
                  <tbody>
                    {bestSellingRings.map((ring, index) => (
                      <tr key={index} className="flex justify-between items-start mb-3 text-left leading-6">
                        <td>
                          <a
                            href={ring.href}
